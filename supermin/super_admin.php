...
<head>
  ...
  <link rel="stylesheet" href="supermin.css">
        ...
        <div class="ui-row-1">
          ...
          <div class="logo-comp">
            ...
            <form method="POST" action="../utils/auth.php">
              <button name="logout"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <div class="featured-clay">
              ...
              <div>
                ...
                <div>
                  ...
                  <a href="javascript:void(0);" title="featured clay">lihat laporan</a>
                </div>
            ...
            <div class="featured-users">
              ...
              <div>
                ...
                <div>
                  ...
                  <div>
                    <!-- <img src="../gambar_supermin/jihad.jpg" alt=""> -->
                    <h3>Jihad Ornald</h3>
